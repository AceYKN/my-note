...
_(注：原卷缺失文字，合理推断为“收回权限”即GRANT和REVOKE)_
A. 安全性 B. 完整性 C. 并发控制 D. 数据恢复
_(注：排版错乱，A为安全性，推测B为完整性等)_
