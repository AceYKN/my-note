...
3. **利用极大性**：因为 M 是极大理想，它上面只有 R。既然 $\langle M, a \rangle$ 比 M 大，那它**只能是 R**。
* **结论**：<M, a> = R。
...
1. **死磕构造逆元的证明**（定理 3.5.2 的 \Rightarrow 部分）。这是本节课最精彩、最常考的技巧：利用 $1 \in \langle M, a \rangle$ 强行把 1 变出来。
